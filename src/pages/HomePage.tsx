...
export function HomePage() {
  ...
  const showOfflineShortcut = appMode === 'offline'
  ...
  return (
    <AppLayout activeBorder="right" topNav={<HomeTopNav />}>
      <main className="flex-grow pt-[88px] px-xl pb-xl max-w-7xl w-full mx-auto">
        <section className="mb-xl relative rounded-xl overflow-hidden bg-surface-container/80 backdrop-blur-sm border border-outline-variant/60 p-xl flex flex-col md:flex-row items-center justify-between gap-xl shadow-elev-1">
          ...
          <div className="z-10 w-full md:w-1/3 flex flex-col gap-md bg-surface/50 p-lg rounded-xl border border-outline-variant backdrop-blur-sm">
            <div className="flex justify-between items-end">
              <span className="font-title-md text-title-md text-secondary">Cấp độ {profile?.level ?? 1}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-xl">
          <div className="lg:col-span-2 flex flex-col gap-lg">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed mt-1">Tái hiện bối cảnh lịch sử qua Tour 360° & Cổng thời gian</p>
              </div>
              <Link to="/explore" className="font-title-md text-title-md text-secondary flex items-center gap-1 card-interactive">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
              <Link
                ...
                className="group relative rounded-xl overflow-hidden h-64 cursor-pointer border border-outline-variant hover:border-secondary card-interactive shadow-elev-1 hover:shadow-elev-2"
              >
              ...
              <Link to="/quests" className="group relative rounded-xl overflow-hidden h-64 cursor-pointer border border-outline-variant hover:border-primary card-interactive shadow-elev-1">
                <div className="absolute inset-0 bg-gradient-to-t from-background via-background/60 to-transparent z-10" />
          ...
          <div className="lg:col-span-1 flex flex-col gap-xl">
            <div className="bg-surface-container border border-outline-variant rounded-xl p-lg flex flex-col gap-md">
              ...
              {showOfflineShortcut && (
                <Link to="/scan" className="flex items-center justify-between p-md rounded-lg bg-surface-container-highest border border-outline-variant hover:border-secondary card-interactive">
              ...
              <Link
                ...
                className="flex items-center justify-between p-md rounded-lg bg-surface-container-highest border border-secondary/30 hover:border-secondary card-interactive"
              >
              ...
              <Link to="/photo-frame" className="flex items-center justify-between p-md rounded-lg bg-surface-container-highest border border-outline-variant hover:border-primary card-interactive">
                <span>Tạo Photo Frame</span>
                <MaterialIcon name="arrow_forward" className="text-primary" />
              </Link>
              <Link to="/leaderboard" className="flex items-center justify-between p-md rounded-lg bg-surface-container-highest border border-outline-variant hover:border-secondary card-interactive">
