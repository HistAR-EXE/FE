...
export const HERITAGE_QUEST_META: Record<string, HeritageQuestMeta> = {
  '33333333-3333-3333-3333-333333333333': {
    ...
    badge: 'Người lính địa đạo',
    difficulty: 'thử thách',
    estimatedMinutes: 25,
    steps: [
      {
        unlockKey: 'scene:22222222-2222-2222-2222-222222222221',
        title: 'Chương 1 · Bếp Hoàng Cầm',
        objective: 'Vào tour 360° và tìm bếp nấu không khói — trụ cột sinh tồn dưới lòng đất.',
        description: 'Không chỉ là nơi nấu ăn: đây là chứng nhân kỹ thuật che giấu khói và nuôi dưỡng hàng ngàn chiến sĩ.',
      ...
      },
      {
        ...
        title: 'Chương 2 · Phòng họp bí mật',
        objective: 'Khám phá phòng họp dưới lòng đất — nơi bàn kế hoạch Tết Mậu Thân.',
        description: 'Một căn phòng nhỏ nhưng quyết định vận mệnh cả vùng đất.',
      ...
      {
        unlockKey: 'era:1948',
        title: 'Chương 3 · Cổng thời gian 1948',
        objective: 'Mở Time Portal 1948 — xem nguồn gốc địa đạo thời kháng chiến chống Pháp.',
        description: 'Quay về năm 1948 để hiểu vì sao mạng lưới hầm được đào.',
        hint: 'Chọn era 1948 trên thanh thời gian.',
        actionType: 'portal',
        actionLabel: 'Mở Time Portal',
        portalEra: 1948,
        xpPartial: 35,
